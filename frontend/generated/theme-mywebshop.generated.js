...
import stylesCss from 'themes/mywebshop/styles.css?inline';
...
import vaadinPasswordFieldCss from 'themes/mywebshop/components/vaadin-password-field.css?inline';
import vaadinTextAreaCss from 'themes/mywebshop/components/vaadin-text-area.css?inline';
import vaadinTextFieldCss from 'themes/mywebshop/components/vaadin-text-field.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_mywebshop_componentCss']) {
    registerStyles(
    ...
    document['_vaadintheme_mywebshop_componentCss'] = true;
  }
